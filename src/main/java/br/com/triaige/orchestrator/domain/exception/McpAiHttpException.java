...
/**
 * Erro HTTP EXPLÍCITO devolvido pelo triaige-srv-mcp-ai (502/504/422/401/etc — spec Fase 4,
 * seção 2.4). Nunca elegível ao retry único de rede: o mcp-ai já esgotou suas próprias
